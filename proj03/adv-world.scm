...
(define Prospect-House (instantiate place 'Prospect-House))
(define Kirin (instantiate place 'Kirin))

(can-go Soda 'north Kirin)  ; Kirin
...
(can-go Intermezzo 'east Prospect-House)   ; Prospect-House
(can-go Prospect-House 'west Intermezzo)
(can-go Soda 'southeast Prospect-House)
(can-go Prospect-House 'northwest Soda)
...
(define YuanFang (instantiate person 'YuanFang Prospect-House))

(define (sproul-hall-exit)
   (lambda () (print "You can check out any time you'd like, but you can never leave")))
